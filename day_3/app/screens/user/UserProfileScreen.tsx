    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.content}>
                ...
                <Typo size={16} color={colors.neutral500} style={{ marginTop: 2 }}>
                    Role: Administrator
                </Typo>
                ...
                <View style={styles.statsContainer}>
                    ...
                    <View style={styles.statBox}>
                        <Typo size={16} fontWeight="600">{getFavoriteNotesCount()}</Typo>
                        <Typo size={14} color={colors.neutral500}>Favorites</Typo>
                    </View>
                </View>
